...
def create(include=None, exclude=None, use_pygments=True, **kwargs):
    ...
    add_tag(SmileyTag, ':)', '../images/emoticons/smile.gif')
    add_tag(SmileyTag, ':-)', '../images/emoticons/smile.gif')
    add_tag(SmileyTag, ':/', '../images/emoticons/unsure.gif')
    add_tag(SmileyTag, ':-/', '../images/emoticons/unsure.gif')
    add_tag(SmileyTag, ':D', '../images/emoticons/grin.gif')
    add_tag(SmileyTag, ':-D', '../images/emoticons/grin.gid')
    add_tag(SmileyTag, ':(', '../images/emoticons/sad.gif')
    add_tag(SmileyTag, ':-(', '../images/emoticons/sad.gif')
    add_tag(SmileyTag, ':o', '../images/emoticons/shock.gif')
    add_tag(SmileyTag, ':-o', '../images/emoticons/shock.gif')
    add_tag(SmileyTag, ':O', '../images/emoticons/shock.gif')
    add_tag(SmileyTag, ':-O', '../images/emoticons/shock.gif')
    add_tag(SmileyTag, ';)', '../images/emoticons/wink.gif')
    add_tag(SmileyTag, ';-)', '../images/emoticons/wink.gif')
    add_tag(SmileyTag, ':P', '../images/emoticons/tongue.gif')
    add_tag(SmileyTag, ':-P', '../images/emoticons/tongue.gif')
    add_tag(SmileyTag, ':p', '../images/emoticons/tongue.gif')
    add_tag(SmileyTag, ':-p', '../images/emoticons/tongue.gif')
    add_tag(SmileyTag, ':S', '../images/emoticons/confused.gif')
    add_tag(SmileyTag, ':-S', '../images/emoticons/confused.gif')
    add_tag(SmileyTag, ':s', '../images/emoticons/confused.gif')
    add_tag(SmileyTag, ':-s', '../images/emoticons/confused.gif')
    add_tag(SmileyTag, 'xD', '../images/emoticons/xd.jpg')
    add_tag(SmileyTag, 'x-D', '../images/emoticons/xd.jpg')
    add_tag(SmileyTag, 'XD', '../images/emoticons/xd.jpg')
    add_tag(SmileyTag, 'X-D', '../images/emoticons/xd.jpg')
    add_tag(SmileyTag, 'woot', '../images/emoticons/woop.jpg')
    add_tag(SmileyTag, 'woop', '../images/emoticons/woop.jpg')
...
class SmileyTag(TagBase):

    """a tag which takes a single bbcode box and replaces it with an image tag
    the alt text is the contents (if there are any)"""

    def __init__(self, name, **kwargs):
        TagBase.__init__(self, name, enclosed=True, auto_close=True, inline=True)
    ...
    def render_open(self, parser, node_index):
        return '<img src="' + self.html_name + '" alt="' + self.name + '" />'
...
class QuoteTag(TagBase):
    ...
    def render_open(self, parser, node_index):
        if self.params:
            return u'<blockquote><em>%s</em><br/><div class="forumquote">'%(PostMarkup.standard_replace(self.params))
        else:
            return u'<blockquote><div class="forumquote">'
